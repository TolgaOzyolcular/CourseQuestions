...
public class SinglyLinkedList<E> implements List<E>, Iterable<E> {
	...
	public int count(E fromElement, E toElement) {
    		...
    		if(indexFrom == null) {
    		...
    		else if(indexFrom.value != fromElement) {
    			System.out.println("FROM: " + indexFrom.value);
    			indexFrom = indexFrom.next;
    			count(fromElement, toElement);
    		}
        		...
        		else if(indexTo.value != toElement) {
        			System.out.println("To: " + indexTo.value);
        			distance++;
